...
|---|---|---|---|---|---|---|---|
| opening | 19 | 19 | 9 | 10 | 100 | 500 | 2000 |
| middlegame | 372 | 372 | 153 | 219 | 100 | 1000 | 3200 |
| endgame | 239 | 239 | 101 | 138 | 100 | 1000 | 3000 |

**Mined**, not shipped. This table is the record of the run that found these
positions, judged at depth 20; `tools/verify_puzzles.js` then takes the same
...
| `longGame` | 469 |
| `hangingPiece` | 465 |
| `defensiveResource` | 367 |
| `pin` | 138 |
| `fork` | 130 |
| `trappedPiece` | 121 |
| `skewer` | 103 |
| `discoveredAttack` | 100 |
| `sacrifice` | 90 |
| `kingAttack` | 84 |
| `pawnBreakthrough` | 68 |
| `removalOfDefender` | 55 |
| `positionalTactic` | 27 |
| `promotion` | 16 |
| `zwischenzug` | 12 |
| `exchangeSacrifice` | 4 |
...
```bash
node tools/generate_puzzles.js --games 1600 --jobs 10 --seed 1
```
...
|---|---|---|---|---|---|---|---|
| `endgame` | 2026-09-05 | 24 | 72 | 5 | 167 | 21 | 72 |
| `middlegame` | 2026-09-05 | 24 | 148 | 0 | 224 | 57 | 147 |
| `opening` | 2026-09-05 | 24 | 4 | 0 | 15 | 1 | 4 |
