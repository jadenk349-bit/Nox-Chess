...
module.exports = {
  ...
  // what verify_puzzles.js reuses rather than re-derives: a corrected line has
  // to be built the way the shipped ones were, and a corrected puzzle re-rated
  // by the same ladder replay
  buildLine, seedRating, uciFind,
