...
master games · 661 tests + 444 API + 368 audit + 3574 explanation assertions.
...
7. **123 of 246 stated conditions have never been read against their matcher.**
   ...
   enforced in the matcher, 20 in Layer 3, 29 argued on a record, **112
   unread**. Fifteen defects have come out of the reading so far, including one
