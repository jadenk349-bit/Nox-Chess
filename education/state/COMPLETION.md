...
|---|---|---|---|
| 1 | All major areas have meaningful depth | **NOT MET** | 5 areas `full`, 11 `substantial`, 69 `partial`. Mean concept completeness 0.79 (was 0.71). |
...
master games · 809 tests + 606 API + 374 audit + 3570 explanation assertions.

Ladder: researched 137, human-grounded 37, engine-verified 88, negative-tested
