...
|---|---|---|---|
| 1 | All major areas have meaningful depth | **NOT MET** | 4 areas `full`, 12 `substantial`, 69 `partial`. Mean concept completeness 0.75 (was 0.71). |
