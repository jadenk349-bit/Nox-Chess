...
|---|---|---|---|
| 1 | All major areas have meaningful depth | **NOT MET** | 5 areas `full`, 11 `substantial`, 69 `partial`. Mean concept completeness 0.80 (was 0.71). |
...
master games · 817 tests + 606 API + 374 audit + 3570 explanation assertions.
