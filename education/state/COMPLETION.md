...
master games · 661 tests + 493 API + 374 audit + 3562 explanation assertions.
...
| | before | after |
|---|---|---|
| human-grounded corpus positions | 6 | 41 |
| corpus games | 2 | 27 |
| corpus roles | 5 positive, 1 ambiguous, 0 negative | 19 positive, 13 ambiguous, 9 negative |
...
7. **123 of 246 stated conditions have never been read against their matcher.**
   ...
   enforced in the matcher, 20 in Layer 3, 29 argued on a record, **75
   unread**. Twenty-four defects have come out of the reading so far, including one
