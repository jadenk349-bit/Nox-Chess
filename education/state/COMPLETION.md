...
The gap is now a single quantity with a name: **ambiguous examples**, 22 of the
...
master games · 888 tests + 741 API + 374 audit + 3570 explanation assertions.
...
explanation-validated 105. Every rung its record allows: **30 of 137.**
...
| concepts with an ambiguous example | 20 of 94 | 72 of 94 |
| mean concept completeness | 0.70 | **0.86** |
