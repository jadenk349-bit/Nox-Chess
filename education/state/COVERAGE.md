...
Mean completeness **0.68** across 135 concepts.
...
| substantial | 0.92 | `bishop-endgames` | 2 |
| substantial | 0.89 | `gambit-principles` | 2 |
| substantial | 0.88 | `king-safety` | 2 |
| substantial | 0.75 | `checks-captures-threats` | 2 |
...
| `bad-bishop` | 0.87 | x | x | x | x | x | x | x | x | - | - | . | x | x | x | x | x |
...
| `material-imbalance` | 0.80 | x | x | x | x | x | x | x | - | - | - | . | x | x | x | x | x |
...
| `semi-open-file` | 0.73 | x | x | x | x | x | x | x | - | - | - | . | x | - | x | x | x |
...
| `piece-activity` | 0.69 | x | x | x | x | x | x | x | - | - | - | - | x | - | x | x | x |
