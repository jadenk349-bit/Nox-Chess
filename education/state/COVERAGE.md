...
Mean completeness **0.78** across 137 concepts.
...
| substantial | 0.97 | `restriction` | 2 |
...
| substantial | 0.66 | `tactical-motifs` | 19 |
...
| `restraint` | 0.93 | x | x | x | x | x | x | x | x | - | x | . | x | x | x | x | x |
...
| `pawn-break` | 0.87 | x | x | x | . | x | x | x | x | - | x | x | - | x | x | x | x |
